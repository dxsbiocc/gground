...
#'
#' ggplot(iris, aes(x = Species, y = Petal.Width, fill = Species)) +
#'   geom_round_half_boxplot(side = "r")
#'
#' ggplot(iris, aes(x = Species, y = Petal.Width, fill = Species)) +
#'   geom_round_half_boxplot(center = TRUE)
#' @rdname geom_round_half_boxplot
#' @export
geom_round_half_boxplot <- function(
...
#' @title GeomRoundHalfBoxplot
#' @format NULL
#' @usage NULL
#' @importFrom ggplot2 alpha ggproto aes GeomSegment GeomPoint resolution PositionJitter
#' @importFrom grid grobTree
#' @export
GeomRoundHalfBoxplot <- ggplot2::ggproto(
    "GeomRoundHalfBoxplot", GeomRoundBoxplot,
